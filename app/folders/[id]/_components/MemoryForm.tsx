...
const FIELDS = ["regret", "people", "place", "outcome"] as const;
...
export function MemoryForm({
    ...
    return (
      <>
        ...
        <div className="flex w-full flex-col gap-4 text-[#503836]">
          ...
          <div className="flex items-center justify-between gap-2">
            <h2 className="text-lg font-bold">당신의 후회를 다시 적어 봤어요</h2>
            <button
              type="button"
  ...
  return (
    <>
      ...
      <div className="flex w-full flex-col gap-4 text-[#503836]">
        <FolderHeading folderName={folderName} days={days} />
        <p className="text-sm font-bold text-[#5DBFA8]">{step} / 4</p>
